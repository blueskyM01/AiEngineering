...
if __name__ == '__main__':
    ...
    parser.add_argument('--cust_data_init_weights_path', default='/root/code/AiEngineering/03-OCR/trocr/cust-data/weights', type=str,
                        help="初始化训练权重，用于自己数据集上fine-tune权重")
    parser.add_argument('--checkpoint_path', default='/root/code/AiEngineering/03-OCR/trocr/checkpoint/trocr', type=str, help="训练模型保存地址")
    parser.add_argument('--dataset_path', default='/root/code/AiEngineering/03-OCR/trocr/dataset/cust-data/train/*/*.jpg', type=str, help="训练数据集")
    ...
    parser.add_argument('--eval_steps', default=10000, type=int, help="模型评估间隔数")
    parser.add_argument('--save_steps', default=2000, type=int, help="模型保存间隔步数")
    ...
    train_paths, test_paths = train_test_split(paths, test_size=0.005, random_state=10086)
