"""
optimum-cli export onnx --model /root/code/AiEngineering/03-OCR/trocr/cust-data/weights --task image-to-text --opset 14 onnx
"""
import cv2
import numpy as np
import onnxruntime
...
class OnnxDecoder():
    def __init__(self, model_path):
        ...
        print("Input names:", self.input_names)  # Add this line to check the input names
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                            help="onnx 模型地址", default='/root/code/AiEngineering/03-OCR/trocr/onnx')
    parser.add_argument('--test_img', type=str, help="测试图像", default='/root/code/AiEngineering/03-OCR/trocr/dataset/cust-data/val/000008516/000008517.jpg')
