...
class CenternetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if len(box) != 0:
            ...
            boxes[:, [0]] = np.clip(boxes[:, [0]] / self.input_shape[1] * self.output_shape[1], 0, self.output_shape[1] - 1)
            boxes[:, [1]] = np.clip(boxes[:, [1]] / self.input_shape[0] * self.output_shape[0], 0, self.output_shape[0] - 1)
