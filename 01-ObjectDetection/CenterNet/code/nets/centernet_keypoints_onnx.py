...
from nets.resnet50_keypoints import resnet50, resnet50_Decoder, resnet50_Head


class CenterNet_keypoints_Resnet50(nn.Module):
    def __init__(self, num_classes = 20, pretrained = False):
        super(CenterNet_keypoints_Resnet50, self).__init__()
