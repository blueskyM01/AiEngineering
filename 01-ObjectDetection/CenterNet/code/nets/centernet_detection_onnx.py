...
from nets.resnet50_detection import resnet50, resnet50_Decoder, resnet50_Head


class CenterNet_detection_Resnet50(nn.Module):
    def __init__(self, num_classes = 20, pretrained = False):
        super(CenterNet_detection_Resnet50, self).__init__()
        ...
        self.mean = torch.tensor([0.40789655, 0.44719303, 0.47026116]).float().cuda()
        self.std = torch.tensor([0.2886383, 0.27408165, 0.27809834]).float().cuda()
        self._init_weights()
