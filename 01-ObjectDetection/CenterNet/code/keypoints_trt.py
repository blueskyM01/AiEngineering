...
input_shape = [512, 512]
class_names = get_classes('/root/code/dataset/crop_cell_guide/annotation/cell_guide.txt')
...
def zpmc_onnx2trt(onnxFile, trtFile_save_dir, trtFile_save_name, FPMode, video_dir, detect_save_dir):
    ...
    cv2.imwrite('/root/code/AiEngineering/01-ObjectDetection/CenterNet/code/img_out/resuts1.jpg', src)
