...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/root/code/AiEngineering/01-ObjectDetection/Yolo-v8/code/logs/ep080-loss2.286-val_loss2.604.pth',
        "classes_path"      : '/root/code/AiEngineering/01-ObjectDetection/Yolo-v8/code/datas/610_classes.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='img/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
