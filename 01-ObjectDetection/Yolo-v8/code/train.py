...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = '/root/code/AiEngineering/01-ObjectDetection/Yolo-v8/code/datas/610_train.txt'
    val_annotation_path     = '/root/code/AiEngineering/01-ObjectDetection/Yolo-v8/code/datas/610_val.txt'
