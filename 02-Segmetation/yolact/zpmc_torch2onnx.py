...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/yolact_base_45_60000.pth', type=str,
    ...
    parser.add_argument('--image', default='test_images/image_0000002313.jpeg:test_images/image_0000002313-out.jpeg', type=str,
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    preds = net(frame)
    torch.onnx.export(net, (frame,), 'onnx/yolact.onnx', verbose=True, opset_version=14, dynamic_axes = {'onnx::Transpose_0':[0]})
...
if __name__ == '__main__':
    ...
    if args.trained_model == 'interrupt': # pass
        args.trained_model = SavePath.get_interrupt('weights/')
    elif args.trained_model == 'latest': # pass
        args.trained_model = SavePath.get_latest('weights/', cfg.name)

    if args.config is None: # pass
