...
# Oof
import zpmc_torch2onnx as eval_script
...
def train():
    ...
    if args.batch_alloc is not None: # pass
    ...
    try:
        for epoch in range(num_epochs):
            ...
            yolact_net.save_weights(os.path.join(args.save_folder , 'yolact_base_{}.pth'.format(epoch)))
